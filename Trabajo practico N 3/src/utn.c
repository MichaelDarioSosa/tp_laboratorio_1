...
static int esFlyCode(char* cadena){
	int retorno = 1;
	int i;
	char flyCode[][51]={"BA2491A","IB0800A","MM0987B","GU2345F","FR5678G","TU6789B",};
	if(cadena != NULL){
		for(i=0;i<7;i++){
			cadena[i] = toupper(cadena[i]);
		}
		if( strcmp(cadena,flyCode[0])!=0 && strcmp(cadena,flyCode[1])!=0 && strcmp(cadena,flyCode[2])!=0&& strcmp(cadena,flyCode[3])!=0&& strcmp(cadena,flyCode[4])!=0&& strcmp(cadena,flyCode[5])!=0){
			retorno = 0;
		}
	}
return retorno;
